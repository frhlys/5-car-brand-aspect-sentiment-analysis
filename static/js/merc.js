...
const Options = {
  series: [5939, 1649, 2533], // Positive, Neutral, Negative (from overallSentiment)
  chart: {
    width: 500,
    type: 'donut',
  ...
  title: { text: "Mercedes-Benz Sentiment Distribution" },
...
// Bar Chart sentiment
const barOptions = {
  title: { text: 'Overall Sentiment Distribution of Mercedes-Benz Brand' },
...
// Bar Chart aspect
const aptOptions = {
  title: { text: 'Overall Aspect Distribution of Mercedes-Benz Brand' },
...
const compareOptions = {
  ...
  dataLabels: { enabled: false },
  stroke: { width: 2 },
  title: { text: 'Distribution of Mercedes-Benz Brand Aspect Sentiment' },
  xaxis: { categories: ['Price', 'Performance', 'Quality', 'Safety', 'Comfort', 'Fuel Efficiency'] },
  yaxis: { title: { text: '' } },
...
var options = {
  ...
  title: { text: 'Total Mention of Sentiments for Mercedes-Benz (2022-2025)', align: 'left' },
  responsive: [{
    breakpoint: 480,
    options: {
      legend: {
...
// Total Mention of Sentiments for Audi (2018-2019)
...
// Total Mention of Aspect for Audi
const aspectMentionOptions = {
  ...
  title: { text: 'Total Mention of Aspect for Mercedes-Benz (2022-2024)', align: 'left' },
  legend: { tooltipHoverFormatter: (val, opts) => `${val} - <strong>${opts.w.globals.series[opts.seriesIndex][opts.dataPointIndex]}</strong>` },
  markers: { size: 0, hover: { sizeOffset: 6 } },
  xaxis: { categories: ['2022', '2023', '2024', '2025'] },
  tooltip: { y: [{ title: { formatter: (val) => `${val} ` } }, { title: { formatter: (val) => `${val}` } }, { title: { formatter: (val) => val } }] },
