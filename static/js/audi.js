...
const Options = {
  series: [5296, 1765, 1016], // Positive, Neutral, Negative (from overallSentiment)
  chart: {
    width: 500,
    type: 'donut',
  ...
  title: { text: "Audi Sentiment Distribution" },
...
// Bar Chart sentiment
const barOptions = {
  title: { text: 'Overall Sentiment Distribution of Audi Brand' },
...
// Bar Chart aspect
const aptOptions = {
  title: { text: 'Overall Aspect Distribution of Audi Brand' },
...
const compareOptions = {
  ...
  dataLabels: { enabled: false },
  stroke: { width: 2 },
  title: { text: 'Distribution of Audi Brand Aspect Sentiment' },
  xaxis: { categories: ['Price', 'Performance', 'Quality', 'Safety', 'Comfort', 'Fuel Efficiency'] },
  yaxis: { title: { text: '' } },
...
var options = {
  ...
  title: { text: 'Total Mention of Sentiments for Audi (2022-2025)', align: 'left' },
  responsive: [{
    breakpoint: 480,
    options: {
      legend: {
...
const aspectMentionOptions = {
  ...
  title: { text: 'Total Mention of Aspect for Audi (2022-2024)', align: 'left' },
  legend: { tooltipHoverFormatter: (val, opts) => `${val} - <strong>${opts.w.globals.series[opts.seriesIndex][opts.dataPointIndex]}</strong>` },
  markers: { size: 0, hover: { sizeOffset: 6 } },
  xaxis: { categories: ['2022', '2023', '2024', '2025'] },
  tooltip: { y: [{ title: { formatter: (val) => `${val} ` } }, { title: { formatter: (val) => `${val}` } }, { title: { formatter: (val) => val } }] },
